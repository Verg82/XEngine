...
public class Settings
{
    ...
    public class Shadows
    {
        ...
        [HelpText("MSAA mode to use for VSM shadow maps")]
        [UseAsShaderConstant(false)]
        ShadowMSAA ShadowMSAA = ShadowMSAA.MSAANone;

        [DisplayName("VSM Format")]
        [HelpText("Texture format to use for VSM shadow maps")]
        [UseAsShaderConstant(false)]
        VSMFormat VSMFormat = VSMFormat.VSM32Bit;

        [DisplayName("VSM Shadow Anisotropy")]
        ...
        [HelpText("Generates mip maps when using Variance Shadow Maps")]
        [UseAsShaderConstant(false)]
