...
protected:
    ...
    PixelShaderPtr meshPS[2][2][2][2][uint64(FixedFilterSize::NumValues)][uint64(ShadowMode::NumValues)][uint64(VSMFormat::NumValues)];

    VertexShaderPtr meshDepthVS;

    VertexShaderPtr fullScreenVS;
    PixelShaderPtr vsmConvertPS[uint64(ShadowMode::NumValues)][uint64(ShadowMSAA::NumValues)][uint64(VSMFormat::NumValues)];
