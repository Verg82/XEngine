...
void InitUI()
{
    ...
    // Generic HUD
    {
        ...
        gSceneSelectCombo->AddItem(L"Tree UCDavis", ULongToPtr(TREE_UCDAVIS_SCENE));
    ...
    // Partition HUD
    {
        ...
        gPartitionsCombo->SetSelectedByData(ULongToPtr(4));
        ...
        gShadowTextureDimCombo->SetSelectedByData(ULongToPtr(1024));
    ...
    // Filtering HUD
    {
        ...
        gFilteringSchemeCombo->SetSelectedByData(ULongToPtr(EVSM_FILTERING));
        ...
        gShadowAACombo->SetSelectedByData(ULongToPtr(4));
    ...
    // Expert HUD
    {
        ...
        HUD->AddCheckBox(UI_ALIGNLIGHTTOFRUSTUM, L"Align Light To Frustum", 0, y, width, 23, gUIConstants.alignLightToFrustum != 0);
        y += 26;
...
void InitScene(ID3D11Device* d3dDevice)
{
    ...
    switch (scene) {
        ...
        case TREE_UCDAVIS_SCENE: {
            gMeshOpaque.Create(d3dDevice, L"..\\media\\TreeRMSM\\trees_c.sdkmesh");
            LoadSkybox(d3dDevice, L"..\\media\\Skybox\\Clouds.dds");
            sceneScaling = 0.8f;
            cameraEye = sceneScaling * D3DXVECTOR3(10.0f, 5.0f, 5.0f);
            cameraAt = sceneScaling * D3DXVECTOR3(10.0f, 0.0f, -5.0f);
            lightDirection = D3DXVECTOR3(32.0f, -30.0f, -22.0f);
        } break;
    };
